...
(function() {
  var Account, Animal, Horse, Person, Snake, age, ages, awardMedals, bitlist, changeNumbers, child, city, close, contenders, contents, copy, countdown, courses, cube, date, dish, eldest, end, evens, filename, fill, first, food, foods, footprints, forecast, futurists, gold, grade, hi, i, inner, kids, last, lyrics, middle, mood, name, num, numbers, open, outer, rest, sam, say, silver, singers, solipsism, song, speed, square, start, street, tag, temp, text, theBait, theSwitch, tim, tom, volume, weatherReport, winner, x, yearsOld, zip, _fn, _i, _j, _k, _l, _len, _len1, _len2, _len3, _m, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8,
    __slice = [].slice,
